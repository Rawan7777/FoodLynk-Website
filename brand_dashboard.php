...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($result) === 1){
        ...
        $insert = "INSERT INTO meals 
                   (brand_name, meal_name, meal_description, meal_price, email, meal_quantity, meal_image, status) 
                   VALUES ('$brand_name', '$meal_name', '$meal_description', '$meal_price', '$email', '$meal_quantity', '$image_path', 'not_active')";
    ...
    <div class="popup-form" id="popup">
        <div class="popup-content">
            ...
            <form method="post" enctype="multipart/form-data">
                <label class="file-label">Upload Meal Image</label>
                ...
                <button type="button" class="btn close-btn" onclick="hidePopup()">Cancel</button>
            </form>
        </div>
    </div>
