...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-header">
            ...
            <button class="add-btn" onclick="showPopup()">Add meal</button>
        </div>
        ...
        if(mysqli_num_rows($result_meals) > 0){
            ...
            while($meal = mysqli_fetch_assoc($result_meals)){
                ...
                echo '  <div class="meal-card">
                            ...
                            <div class="info">
                                <span>Qty: ' . $meal['meal_quantity'] . '</span>
        ...
        ?>
            ...
            <div class="meal-card">
                <img src="images/atacadao.png" alt="Meal 1" />
                <h4>Spaghetti</h4>
    ...
    <div class="popup-form" id="popup">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <input type="number" name="meal_quantity" placeholder="Quantity" required />
